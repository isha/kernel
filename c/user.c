...
/****************************/
	...
	if(echo_fd == -3) sysputs("Error, device already in use \n");
	if(echo_fd == -2) sysputs("Error, bad device number. \n");
	if(echo_fd == -1) sysputs("Error, no empty fdslot. \n");
	if(echo_fd > -1) sysputs("fd retreival success! \n");
	...
	if(noecho_fd == -3) sysputs("Error, device already in use \n");
	if(noecho_fd == -2) sysputs("Error, bad device number. \n");
	if(noecho_fd == -1) sysputs("Error, no empty fdslot. \n");
	if(noecho_fd > -1) sysputs("fd retreival success! \n");
